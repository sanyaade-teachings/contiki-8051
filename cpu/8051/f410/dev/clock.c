...
clock_init(void)
{
  CKCON = OSC32K |  TICKSPD2|TICKSPD1|TICKSPD0;	/*tickspeed 250 kHz*/
  ...
  ST2 = (unsigned char) (timer_value >> 16);          /*Sleep timers 0 ro 1 or 2 */
...
/*---------------------------------------------------------------------------*/
void
8051_clock_ISR( void ) __interrupt (ST_VECTOR)
{
